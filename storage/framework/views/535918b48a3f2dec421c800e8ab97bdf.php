...
<head>
  ...
  <style>
    ...
    .hero {
      ...
      text-align: center;
      padding: 80px 20px;
      background: linear-gradient(rgba(90, 70, 52, 0.8), rgba(90, 70, 52, 0.8)), url("<?php echo e(asset('pictures/cat.jpg')); ?>") center/cover no-repeat;
      color: #f5f5dc;
    }
...
<?php /**PATH C:\xampp\htdocs\myapp\resources\views/home.blade.php ENDPATH**/ ?>